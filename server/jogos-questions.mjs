export const jogosQuestions = [
  ...
  },
  {
    ...
    "options": [
      ...
      "instância, objeto e recursos",
      "recurso, comportamento e cenas",
      "sprite, variável e eventos"
    ],
    "correct": 0
  },
  {
  ...
  },
  {
    ...
    "options": [
      ...
      "X e Y somente para cima",
      "X para baixo e Y para a direita",
      "X e Y não possuem direção"
    ],
    "correct": 0
  },
  {
  ...
  },
  {
    ...
    "options": [
      ...
      "deslocamento = FPS × número de cenas",
      "deslocamento = posição × volume",
      "deslocamento = tempo do quadro ÷ velocidade"
    ],
    "correct": 0
  },
  {
    ...
    "options": [
      ...
      "a vida do jogador",
      "a quantidade de objetos selecionados",
      "o volume da música"
    ],
    "correct": 0
  },
